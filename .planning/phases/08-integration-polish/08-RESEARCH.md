...
- `n8n`: `node /home/lwb3/n8n-mcp-server/index.js`
- `ollama`: `node /home/lwb3/ollama-mcp-server/index.js`
- `sqlite`: `node /home/lwb3/sqlite-mcp-server/index.js`
- `epistemic`: `node /home/lwb3/epistemic-mcp/src/index.js`
...
**How to avoid:** Follow exact pattern: `"command": "node", "args": ["/home/lwb3/ableton-mcp/src/index.js"]`. Note this project uses `src/index.js` not just `index.js` at root.
