...
<task type="auto">
  ...
  - Path is absolute: `/home/user/ableton-mcp/src/index.js`
  ...
  <done>
  "ableton" MCP server registered in ~/.claude/settings.json with command "node" and args ["/home/user/ableton-mcp/src/index.js"].
