...
- User's existing MCP servers at `/home/user/n8n-mcp-server/`, `/home/user/sqlite-mcp-server/`, `/home/user/epistemic-mcp/`—verified package.json dependencies, SDK import patterns, tool registration schemas, error handling conventions
